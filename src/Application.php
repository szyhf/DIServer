...
//	var_dump(interface_exists(IBootstrapper::class));
	$this->IOC()->RegisterClass(Bootstrapper::class);
	$this->IOC()->RegisterInterfaceByClass(IBootstrapper::class, Bootstrapper::class);
    }
	...
	$bootstrapper = $this->IOC()->GetInstance(IBootstrapper::class);
	$bootstrapper->Boot();
    }
