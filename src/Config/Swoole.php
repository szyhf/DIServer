...
return [
    ...
    'message_queue_key' => '', //设置消息队列的KEY
    'daemonize' => DI_DAEMONIZE,
    ...
    'enable_unsafe_event' => FALSE, //在配置dispatch_mode=1或3后，因为系统无法保证onConnect/onReceive/onClose的顺序，默认关闭了onConnect/onClose事件。
