...
use DIServer\DI\DIContainer\Exception\DependenceCycleException;
use DIServer\DI\DIContainer\Exception\MakeFailedException;
use DIServer\DI\DIContainer\Exception\NotExistException;
use DIServer\DI\DIContainer\Exception\NotRegistedException;
use DIServer\DI\DIContainer\Exception\NotTypeOfInstanceException;
use DIServer\DI\DIContainer\Exception\RegistedException;
use DIServer\DI\DIContainer\Exception\UnresolvableParameterException;
...
class DIContainer implements \ArrayAccess
{
     ...
     * @throws \DIServer\DI\DIContainer\Exception\ClassNotExistException
     * @throws \DIServer\DI\DIContainer\Exception\RegistedException
     */
     ...
     * @param string $key （可选）多例模式下的key
     * @throws \DIServer\DI\DIContainer\Exception\NotTypeOfInstanceException
     */
     ...
     * @throws \DIServer\DI\DIContainer\Exception\NotExistException
     * @throws \DIServer\DI\DIContainer\Exception\RegistedException
     */
     ...
     * @param string $key （可选）多例模式下的key
     * @throws \DIServer\DI\DIContainer\Exception\NotRegistedException
     * @throws \DIServer\DI\DIContainer\Exception\DependenceCycleException
     * @throws \DIServer\DI\DIContainer\Exception\MakeFailedException
     * @return mixed
     */
     ...
     * @throws \DIServer\DI\DIContainer\Exception\UnresolvableParameterException 无法获得
     */
	...
	catch (\DIServer\DI\DIContainer $ex)
	{
	    //先尝试直接从容器获取对应实例
	    //如果没有再考虑该参数的默认值
	    //要不就挂了
